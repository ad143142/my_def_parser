...
int def_parser(int argc, char **argv, def_info_t &def_info)
{
  ...
  if (noCalls == 0)
  {
    ...
    defrSetSNetCbk(snetf);               /////////////////////FIXME://////////////////////////////////////////////////
    defrSetSNetPartialPathCbk(snetpath); ///////////////////////FIXME:////////////////////////////////////////////////
    defrSetSNetWireCbk(snetwire);        ///////////////////////FIXME:////////////////////////////////////////////////
    ...
    defrSetNonDefaultCbk(ndr); ///////////////////////FIXME:for wire/via width for every layer
    ...
    defrSetUnitsCbk(units); ///////////////////////FIXME:get unit
    // if (!retStr)
